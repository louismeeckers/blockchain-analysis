...
def get_single_block_data(block, interests, tx_interests):
...
def independant_data(height):
    ...
    return [height] + get_single_block_data(block, interests, tx_interests)
...
def gather_statistics(from_height, to_height, interests, tx_interests):
    ...
    for height in range(from_height, to_height):
        ...
        block_data.loc[height, :] = get_single_block_data(block, interests, tx_interests)
